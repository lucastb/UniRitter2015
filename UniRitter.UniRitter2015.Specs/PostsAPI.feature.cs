...
#line 19
 testRunner.Then("I get a list containing the populated resources from post", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
...
#line 40
 testRunner.And("I receive the posted resource for post", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 41
 testRunner.And("the posted resource now has an ID for post", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 42
 testRunner.And("I can fetch it from the API for post", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            this.ScenarioCleanup();
        }
